...
class DashboardTextChannelComboBox(label: String, guildId: Long, val selectedChannels: CustomObservableList<Long>, canBeEmpty: Boolean, max: Int) : DashboardComboBox(label, DataType.TEXT_CHANNELS, canBeEmpty, max) {
