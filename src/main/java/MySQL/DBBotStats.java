...
public class DBBotStats {
    ...
    public static void saveStatsServers(int serverCount) throws SQLException {
    ...
    public static void saveStatsCommandUsages() throws SQLException {
    ...
    public static void saveStatsUpvotes() throws SQLException, ExecutionException, InterruptedException {
    ...
    public static void saveStatsUniqueUsers() throws SQLException {
