...
public class DBWelcomeMessage extends DBBeanGenerator<Long, WelcomeMessageBean> {
    ...
    @Override
    protected void saveBean(WelcomeMessageBean welcomeMessageBean) throws SQLException {
        PreparedStatement preparedStatement = DBMain.getInstance().preparedStatement("REPLACE INTO ServerWelcomeMessage (serverId, activated, title, description, channel, goodbye, goodbyeText, goodbyeChannel) VALUES (?, ?, ?, ?, ?, ?, ?, ?);");
