...
public class ShipGraphics {
    ...
    public static InputStream createImageShip(User user1, User user2, int n, int percentage) throws IOException {
        ...
        GraphicsUtil.drawStringWithBorder(g, simIterator, fontSimilarity.getStringBounds(percentage + "%", frc), mainColor, Color.BLACK, image.getWidth() / 2, y - (int) (0.252 * fsize), 4, -1);
