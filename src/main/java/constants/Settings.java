...
public interface Settings {
    ...
    String[] NSFW_FILTERS = { "shota", "loli", "bestiality", "beastiality", "zoophilia", "cub", "vore", "gore", "guro",
            "scat", "rape", "necrophilia", "corpse", "children", "child", "kid", "kids", "teen", "teenager", "young",
            "underage", "underaged", "suicide", "cunny" };
