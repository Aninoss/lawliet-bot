        ...
        for(Class c: CommandContainer.getInstance().getCommandList()) {
            try {
                ...
                if (!trigger.equals("help")) {
                    ...
                    commandJSON.put("title", webComServer.getLanguagePack(command, "title"));
                    commandJSON.put("desc_short", webComServer.getLanguagePack(command, "description"));
                    commandJSON.put("desc_long", webComServer.getLanguagePack(command, "helptext"));
                    commandJSON.put("usage", webComServer.getCommandSpecs(command, "usage"));
                    commandJSON.put("examples", webComServer.getCommandSpecs(command, "examples"));
