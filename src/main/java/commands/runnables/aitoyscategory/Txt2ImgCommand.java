...
public class Txt2ImgCommand extends Command implements OnStringSelectMenuListener {
    ...
    public static String[] NSFW_FILTERS = {"porn", "porno", "pornography", "sex", "intercourse", "coitus", "explicit", "fuck", "fucking", "fucked", "rape", "raping", "raped", "blowjob", "anal", "penis", "cock", "dick", "vagina", "pussy", "cum", "sperm"};
