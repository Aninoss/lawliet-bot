...
import commands.commandrunnables.casinocategory.CoinFlipCommand;
import commands.commandrunnables.fisherysettingscategory.*;
import commands.commandrunnables.informationcategory.*;
import commands.commandrunnables.casinocategory.*;
import commands.commandrunnables.emotescategory.*;
import commands.commandrunnables.externalcategory.*;
import commands.commandrunnables.gimmickscategory.*;
import commands.commandrunnables.informationcategory.HelpCommand;
import commands.commandrunnables.interactionscategory.*;
import commands.commandrunnables.moderationcategory.*;
import commands.commandrunnables.nsfwcategory.*;
import commands.commandrunnables.fisherycategory.*;
import commands.commandrunnables.managementcategory.*;
import commands.commandrunnables.splatoon2category.*;
