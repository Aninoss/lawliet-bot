...
import commands.commandslots.casinocategory.CoinFlipCommand;
import commands.commandslots.fisherysettingscategory.*;
import commands.commandslots.informationcategory.*;
import commands.commandslots.casinocategory.*;
import commands.commandslots.emotescategory.*;
import commands.commandslots.externalcategory.*;
import commands.commandslots.gimmickscategory.*;
import commands.commandslots.informationcategory.HelpCommand;
import commands.commandslots.interactionscategory.*;
import commands.commandslots.moderationcategory.*;
import commands.commandslots.nsfwcategory.*;
import commands.commandslots.fisherycategory.*;
import commands.commandslots.managementcategory.*;
import commands.commandslots.splatoon2category.*;
