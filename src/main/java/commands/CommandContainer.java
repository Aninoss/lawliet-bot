...
public class CommandContainer {
    ...
    static {
        ...
        commandList.add(NSFWTopicCommand.class);
        ...
        commandList.add(CustomRoleManageCommand.class);
        ...
        commandList.add(UnlockCommand.class);
        ...
        commandList.add(AutoStocksCommand.class);
        ...
        commandList.add(SquirtingCommand.class);
        ...
        commandList.add(TagsCommand.class);
