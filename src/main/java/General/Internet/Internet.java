...
public class Internet {
    ...
    public static CompletableFuture<InternetResponse> getData(String urlString, Pair... properties) throws IOException {
        return getData(urlString, "GET", 0, null, properties);
    }

    public static CompletableFuture<InternetResponse> getData(String urlString, String body, Pair... properties) throws IOException {
        return getData(urlString, "POST", 0, body, properties);
    }

    public static CompletableFuture<InternetResponse> getData(String urlString, String method, String body, Pair... properties) throws IOException {
        return getData(urlString, method, 0, body, properties);
    }

    public static CompletableFuture<InternetResponse> getData(String urlString, int pauseTimeMilis, Pair... properties) throws IOException {
        return getData(urlString, "GET", pauseTimeMilis, null, properties);
    }

    public static CompletableFuture<InternetResponse> getData(String urlString, int pauseTimeMilis, String body, Pair... properties) throws IOException {
        return getData(urlString, "POST", pauseTimeMilis, body, properties);
    }

    public static CompletableFuture<InternetResponse> getData(String urlString, String method, int pauseTimeMilis, String body, Pair... properties) throws IOException {
    ...
    private static void download(CompletableFuture<InternetResponse> future, String urlString, String method, int pauseTimeMilis, String body, Pair... properties) {
        try {
            BufferedReader br;
            String line;
