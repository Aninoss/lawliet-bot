                ...
                resultSet -> {
                    if (resultSet.next()) {
                        ...
                        return new WelcomeMessageData(
                                serverId,
                                false,
                                TextManager.getString(locale, Category.CONFIGURATION, "welcome_standard_title"),
                                TextManager.getString(locale, Category.CONFIGURATION, "welcome_standard_description"),
                                0L,
                                true,
                                false,
                                TextManager.getString(locale, Category.CONFIGURATION, "welcome_standard_goodbye"),
                                0L,
                                true,
                                false,
                                "",
