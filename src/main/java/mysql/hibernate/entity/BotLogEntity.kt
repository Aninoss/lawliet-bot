...
class BotLogEntity(
    ...
    enum class Event(val valuesRelationship: ValuesRelationship = ValuesRelationship.EMPTY, val valueType: ValueType? = null) {
        ...
        FISHERY_VOTE_REWARDS_ACTIVE(ValuesRelationship.OLD_AND_NEW, ValueType.BOOLEAN),
        FISHERY_VOTE_REWARDS_LOG_CHANNEL(ValuesRelationship.OLD_AND_NEW, ValueType.CHANNEL),
        FISHERY_VOTE_REWARDS_PORTION_OF_DAILY(ValuesRelationship.OLD_AND_NEW, ValueType.INTEGER),
        FISHERY_VOTE_REWARDS_GENERATE_AUTH,
