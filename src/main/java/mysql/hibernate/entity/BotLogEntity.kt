...
class BotLogEntity(
    ...
    enum class Event(val valuesRelationship: ValuesRelationship = ValuesRelationship.EMPTY, val valueType: ValueType? = null,
        ...
        NSFW_OLD_MESSAGE_LAYOUT(ValuesRelationship.OLD_AND_NEW, ValueType.BOOLEAN, NSFWConfigCommand::class.java, "nsfwconfig_root_old_message_layout_label"),
        ...
        WELCOME_DM_IMAGES_ADD,
        WELCOME_DM_IMAGES_REMOVE,
        ...
        WELCOME_LEAVE_IMAGES_ADD,
        WELCOME_LEAVE_IMAGES_REMOVE,
