...
public class YaoiHugCommand extends InteractionCommand implements onRecievedListener {
    private static ArrayList<Integer> picked = new ArrayList<>();

    public YaoiHugCommand() {
        super("https://media.giphy.com/media/yziFo5qYAOgY8/giphy.gif",
