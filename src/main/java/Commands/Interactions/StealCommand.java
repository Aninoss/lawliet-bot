...
public class StealCommand extends InteractionCommand implements onRecievedListener {
    private static ArrayList<Integer> picked = new ArrayList<>();

    public StealCommand() {
        super("https://media1.tenor.com/images/f2be72f3aa513baa5782aa768f27c860/tenor.gif?itemid=10194720",
