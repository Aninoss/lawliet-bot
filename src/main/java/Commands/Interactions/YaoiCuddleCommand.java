...
public class YaoiCuddleCommand extends InteractionCommand implements onRecievedListener {
    private static ArrayList<Integer> picked = new ArrayList<>();

    public YaoiCuddleCommand() {
        super("https://media1.tenor.com/images/a8cbc11ee331c62aaf03420d99696da0/tenor.gif?itemid=9556155",
