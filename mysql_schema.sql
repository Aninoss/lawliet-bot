...
--
-- Table structure for table `AutoSell`
--

DROP TABLE IF EXISTS `AutoSell`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `AutoSell` (
  `userId` bigint unsigned NOT NULL,
...
--
-- Table structure for table `DevVotesReminders`
--

DROP TABLE IF EXISTS `DevVotesReminders`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `DevVotesUservotes`
--

DROP TABLE IF EXISTS `DevVotesUservotes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `DevVotesUservotes` (
  `userId` bigint unsigned NOT NULL,
  `year` smallint unsigned NOT NULL,
  `month` tinyint unsigned NOT NULL,
  `selected` varchar(50) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`userId`,`year`,`month`,`selected`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ReactionRolesMessage` (
  ...
  `roleRemoval` tinyint NOT NULL,
  `multipleRoles` tinyint NOT NULL,
  `newComponents` tinyint NOT NULL,
  `showRoleNumbers` tinyint NOT NULL,
  `showRoleConnections` tinyint DEFAULT NULL,
...
--
-- Table structure for table `ReactionRolesRoleRequirement`
--

DROP TABLE IF EXISTS `ReactionRolesRoleRequirement`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ReactionRolesRoleRequirement` (
  `messageId` bigint unsigned NOT NULL,
  `roleId` bigint unsigned NOT NULL,
  PRIMARY KEY (`messageId`,`roleId`),
  CONSTRAINT `ReactionRolesRoleRequirementStaticReactionMessagesBase` FOREIGN KEY (`messageId`) REFERENCES `StaticReactionMessages` (`messageId`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `UserPrivateChannels` (
  `botId` bigint unsigned NOT NULL DEFAULT '368521195940741122',
  `userId` bigint unsigned NOT NULL,
  `privateChannelId` bigint unsigned NOT NULL,
  PRIMARY KEY (`userId`,`botId`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
